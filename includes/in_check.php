...
<table width="750" border="0" align="center">
  <tr>
    <td height="43" colspan="2" align="center" valign="middle"><p><a href="../admin.php?action=insert">INSERT ENGINES</a></p></td>
    <td colspan="2" align="center" valign="middle"><a href="../admin.php?action=edit">EDIT ENGINES</a></td>
  </tr>
  <tr>
    <td colspan="4"><p><?php
    if($_GET[number]>0){
